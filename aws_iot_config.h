...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "aaaoogrfi3i68-ats.iot.us-west-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
...
#define AWS_IOT_ROOT_CA_FILENAME       "Amazon_Root_CA_1.pem" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "rPiCertificate.pem" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "ee5a22aeb4-private.pem.key" ///< Device private key filename
// =================================================
